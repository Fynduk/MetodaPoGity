...
![Workflow](https://github.com/Fynduk/MetodaPoGity/tree/master/img/githubInstruction.png)
...
![Fork](https://github.com/Fynduk/MetodaPoGity/tree/master/img/fork.png)

Через несколько секунд на сервере GitHub будет создана ваша копия репозитория проекта.

![Forking](https://github.com/Fynduk/MetodaPoGity/tree/master/img/forking.png)
...
![Pull request 1](https://github.com/Fynduk/MetodaPoGity/tree/master/img/pullrequest1.png)

На появившейся странице будут отображены изменения, которые вы внесли в файлы репозитория. Нажмите Create pull request.

![Pull request 2](https://github.com/Fynduk/MetodaPoGity/tree/master/img/pullrequest2.png)
...
![Comment on pull request](https://github.com/Fynduk/MetodaPoGity/tree/master/img/comment_on_pullrequest.png)
...
![Conversation](https://github.com/Fynduk/MetodaPoGity/tree/master/img/conversation.png)
...
![Alert](https://github.com/Fynduk/MetodaPoGity/tree/master/img/alert.png)
...
![Travis CI](https://github.com/Fynduk/MetodaPoGity/tree/master/img/travis_ci_proc.png)

После проверки, если есть ошибки в коде Travis CI расскажет об этом(Details - для просмотра ошибок)

![Travis CI Failed](https://github.com/Fynduk/MetodaPoGity/tree/master/img/travis_ci_failed.png)

В случае успешной проверки, преподаватель увидит это и проверит вашу работу.

![Travis CI Done](https://github.com/Fynduk/MetodaPoGity/tree/master/img/travis_ci_done.png)

![Happy End](https://github.com/Fynduk/MetodaPoGity/tree/master/img/happy_end.png)
